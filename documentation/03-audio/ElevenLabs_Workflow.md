...
1. **Week 1:** Write all 25 episode scripts
2. **Week 2:** Theological review by advisors
3. **Week 3:** Generate audio (ElevenLabs)
4. **Week 4:** Upload to Firebase + metadata
5. **Week 5:** QA testing, iterate if needed
